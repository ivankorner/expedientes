...
try {
    ...
    echo "<p><strong>Actualización 2025:</strong> Se agregaron 36 nuevos tipos de entidades, algunos con códigos de hasta 5 caracteres.</p>";
    echo "<p><strong>Tipos con códigos largos:</strong> COOPR, CCOM, CREH, etc. requieren que tipo_entidad sea VARCHAR(10) mínimo.</p>";
    echo "<div class='mt-3'>";
    echo "<a href='reparar_tipos_entidad.php' class='btn btn-warning'>";
    echo "<i class='bi bi-tools'></i> Reparar Tipos Truncados";
    echo "</a>";
    echo "</div>";
    echo "</div>";
